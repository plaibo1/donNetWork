...
const PersonalData = () => {
  return (
    <ContainerLayout>
      <div>
        <HeadingLeft title={"Политика конфиденциальности"} subTitle={null} />
        ...
        <div>
          <p className="mb-5">
            ...
            персональных данных, предпринимаемые ООО «Донтехсвязь» (далее –
            Оператор).
          </p>
          ...
          <p>
            ...
            https://www.donnetwork.ru/.
          </p>
          <p>
            Основные понятия, используемые в Политике 2.1. Автоматизированная
          ...
          <p>
            ...
            Пользователя 3.1. Фамилия, имя, отчество Электронный адрес Номера
            телефонов;
          </p>
          <p>3.2. Год, месяц, дата и место рождения;</p>
          <p>3.3. Фотографии;</p>
          <p>
          ...
          <p>
            4.1. Цель обработки персональных данных Пользователя — уточнение
            данных заказа;
          </p>
          <p>
            ...
            электронной почты{" "}
            <a className="text-baseColor-40" href="mailto:dts@donnetwork.ru">
              dts@donnetwork.ru
            </a>{" "}
          ...
          <p>
            ...
            https://www.donnetwork.ru/. Заполняя соответствующие формы и/или
          ...
          <p>
            ...
            Оператора dts@donnetwork.ruс пометкой «Актуализация персональных
            данных».
          </p>
          <p>
            ...
            <a href="mailto:dts@donnetwork.ru">dts@donnetwork.ru</a> с пометкой
          ...
          <p>
            ...
            к Оператору с помощью электронной почты dts@donnetwork.ru
          </p>
          <p>
          ...
          <p>
            ...
            сети Интернет по адресу: https://www.donnetwork.ru/
          </p>
        </div>
