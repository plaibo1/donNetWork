...
const AnyQuestion = ({ setIsOpen }) => {
  return (
    <ContainerLayout>
      <div
        className="w-full rounded-3xl border border-slate-200 flex sm:items-center flex-col 
        sm:flex-row px-6 py-8 sm:px-10 sm:py-16"
      >
        <div className="md:w-4/5">
          <span className="block text-xl mb-5 sm:mb-10">
            Остались вопросы по подключению?
          </span>
          ...
          <div className="flex flex-col xl:flex-row xl:items-end">
            ...
            <span className="xl:ml-5 text-xl mb-7 mt-5 xl:mt-0 md:mb-0">
