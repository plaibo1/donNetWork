...
export const TariffOffice = () => {
  ...
  return (
    <>
      <div
        className='box-border shadow-md rounded-2xl overflow-hidden relative mb-6 sm:mb-0 z-10 bg-white flex justify-between flex-col'
      >
        ...
        <div className="bg-slate-50 px-4 sm:px-6 py-7">
          ...
          <div className='h-[110px] lg:h-20'>
            Здесь описание офисов
          </div>
